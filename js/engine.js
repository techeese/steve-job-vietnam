...
if (typeof window !== "undefined") { window.__test = __test; window.HVS = { S: function () { return S; }, freshState: freshState, loadGame: loadGame, saveGame: saveGame, clockTick: clockTick, dayTick: dayTick, placeRoom: placeRoom, autoPlace: autoPlace, canPlace: canPlace, finalizeJune: finalizeJune, resolveEvent: resolveEvent, resolveContract: resolveContract, checkMilestones: checkMilestones, studentMajor: studentMajor, khoaHeaded: khoaHeaded, khoaThreshold: khoaThreshold, setKhoaHead: setKhoaHead, teacherById: teacherById, contributeQuy: contributeQuy, mentorStudent: mentorStudent, mentorCount: mentorCount }; } // declareAdmissions/derivedPool added to HVS by js/sim/admissions.js (defined there, after this runs)
