...
var CONFIG = {
  ...
  ROOMS: {
    phonghoc: { name: "Phòng học", w: 3, h: 2, cost: 0, once: true, desc: "Nơi mọi giấc mơ bắt đầu bằng điểm danh." },
    san:      { name: "Sân trường", w: 4, h: 3, cost: 0, once: true, desc: "Mặt sân đa năng: thể dục, khai giảng, tránh nắng." },
    cangtin:  { name: "Căng Tin Mì Tôm", w: 2, h: 2, cost: 0, free: true, once: true, desc: "+1 Mood/tháng toàn trường. Ngân hàng tặng kèm khi bán nợ." },
    lab:      { name: "Phòng Lab Sống Ảo", w: 2, h: 2, cost: 70, once: true, desc: "+0,5 Tiếng Tăm/tháng. Đẹp nhất trường. Không dạy được gì." },
    phongmay: { name: "Phòng Máy", w: 3, h: 2, cost: 120, once: true, desc: "Mở khoá toàn bộ hiệu quả Đồ Án & Lab (thiếu nó: -50%)." },
    xuong:    { name: "Xưởng Chế", w: 3, h: 3, cost: 200, once: true, desc: "+1 Tay Nghề khi học Đồ Án. +5 Thực Chất một lần. Bừa bộn, không lên hình." },
