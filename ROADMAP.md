...
- `SMALL_SHIPS_SINCE_EPIC: 0`   → ≥3 ⇒ epic track locks (→ resolve via review-defer; epic AWAITS OWNER STEER, per iter-92). (Reset iter 101: locked slot resolved via review-defer; shipped OG/social meta tags alongside.) **Plateau mode**: content-variety/dead-content/coverage veins exhausted; remaining safe value scarce — lean toward periodic maintenance + awaiting steer over micro-churn.
