...
- `SMALL_SHIPS_SINCE_EPIC: 2`   → ≥3 ⇒ epic track locks (→ resolve via review-defer; next true epic AWAITS OWNER STEER, per iter-92). **Plateau mode**: ship genuine safe value until steer. (98 alumLines×2 + 99 visitLines-variety = 2 POLISH.)
