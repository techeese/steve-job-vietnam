...
- `LAST_MAINTENANCE: iter 167 — CLEAN (gate green, bot BOTOK, sweep 6✓; save/reload of a big-campus empire state INTACT — no dropped students, milestones/tier/cash preserved; 390px mobile audit clean — empire tier fits under the name, tỷ numbers read, real Kenney/Jephed art renders; teacher chip unit fix). Both owner arcs (people-first soul + economy scale) delivered. Prior: iter 97.`
