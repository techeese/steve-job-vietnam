...
- `SHIPS_SINCE_PERSONSIM: 1`    → **(PEOPLE-FIRST ARC) ≥1 ⇒ this firing HARD-LOCKS to a person-sim pick/epic (Compass 1/2); a non-person-sim pick is ILLEGAL.** Reset 0 only on a person-sim ship. The "graphics WINS" counter, repointed. (=1: iter-115 clock speedup — owner-asked UX preemption; next firing returns to person-sim — E15's preset-legibility, E4, or [EVOLUTION] craft.)
- `SMALL_SHIPS_SINCE_EPIC: 1`   → ≥3 ⇒ EPIC-LOCKED. (+1 iter 115 clock.)
