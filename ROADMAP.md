...
- `SMALL_SHIPS_SINCE_EPIC: 2`   → ≥3 ⇒ the next firing is **HARD-LOCKED to the EPIC track**. Reset to 0 only when an epic SHIPS. (89 README + 90 meter-help = 2 POLISH; ONE more then the EPIC track locks — and the genuine epics are queued for owner steer, see below.)
