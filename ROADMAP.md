...
- `SMALL_SHIPS_SINCE_EPIC: 3`   → **≥3 ⇒ EPIC-LOCKED: iter 119 MUST be the EPIC track.** (+1 iter 115 clock, +1 iter 116 ceiling, +1 iter 118 preset-legibility.) Next epic candidates: **E11** (walk-in rooms + activity→development — owner-fresh, visible, de-risked) · the deeper [EVOLUTION] craft-symmetry · E4.
